...
const AllOrders = () => {
  ...
  useEffect(() => {
    const fetch = async ()=> {
      const response = await axios.get(
        "https://book-store-server-tq2z.onrender.com/api/v1/get-all-orders",
        {headers}
      );
  ...
  const submitChanges = async (i) => {
    ...
    const response = await axios.put(`https://book-store-server-tq2z.onrender.com/api/v1/update-status/${id}`,
      Values,
      {headers}
    );
